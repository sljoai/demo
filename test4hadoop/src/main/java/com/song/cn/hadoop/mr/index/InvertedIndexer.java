...
public class InvertedIndexer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String stopWordsFilePath = "/hadoop/test/conf/";
//        Files.mkdirFolder(stopWordsFilePath);
//        Files.uploadFile(localPath,fileName,stopWordsFilePath);
...
//        conf.set("mapreduce.job.jar",jarPath);
        ...
        DistributedCache.addCacheFile(new URI(
                "hdfs://sparkproject1:9000/hadoop/test/conf/stop_words.txt"), conf);// 设置停词列表文档作为当前作业的缓存文件
